...
//cd "/home/alberto/Documents/GitHub/AyED/algoritmosOrdenamiento/listaLigadaOrdenamiento/" && gcc mainOrdennamiento.c lista.c ordenamiento.c -o mainOrdennamiento && "/home/alberto/Documents/GitHub/AyED/algoritmosOrdenamiento/listaLigadaOrdenamiento/"mainOrdennamiento
#include "funciones.h"
...
int main(){
    ...
    do
    {
        ...
        case 7:
            ;
            int aux1=0,aux2=0;
            printf("ingresa indice 1\n");scanf("%d",&aux1);
            printf("ingresa indice 2\n");scanf("%d",&aux2);
            intercambio(&cabeza,aux1,aux2);
            break;
        default:
        printf("BYE");
            break;
