...
typedef struct snodo2{       //snodo es el nombre de la estructura
    int valor;
    struct snodo *sig;      //El puntero siguiente para recorrer la lista enlazada
    struct snodo *ant;
}tnodo2;                     //tnodo es el tipo de dato para declarar la estructura
 
typedef tnodo2 *tpuntero2;    //Puntero al tipo de dato tnodo para no utilizar punteros de punteros
